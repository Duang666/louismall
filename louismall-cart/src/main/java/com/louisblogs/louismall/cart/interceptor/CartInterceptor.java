package com.louisblogs.louismall.cart.interceptor;

import com.louisblogs.common.constant.AuthServerConstant;
import com.louisblogs.common.constant.CartConstant;
...
/**
 * @author ：luqi
 * @description：在执行目标方法之前，判断用户的登录状态。并封装传controller目标请求
 * @date ：2021/6/25 21:28
 */
...
public class CartInterceptor implements HandlerInterceptor {
	...
	public void postHandle(HttpServletRequest request, HttpServletResponse response, Object handler, ModelAndView modelAndView) throws Exception {
		...
		if (!userInfoTo.isTempUser()) {
			...
			//设置cookie作用域
			cookie.setDomain("louismall.com");
			//cookie的过期时间
