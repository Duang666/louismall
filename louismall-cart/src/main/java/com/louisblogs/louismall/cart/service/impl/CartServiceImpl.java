package com.louisblogs.louismall.cart.service.impl;

import com.alibaba.fastjson.JSON;
import com.alibaba.fastjson.TypeReference;
import com.louisblogs.common.utils.R;
import com.louisblogs.louismall.cart.feign.ProductFeignService;
...
import com.louisblogs.louismall.cart.vo.SkuInfoVo;
...
public class CartServiceImpl implements CartService {
	...
	//购物车前缀
	private final String CART_PREFIX = "louismall:cart:";
	...
	private BoundHashOperations<String, Object, Object> getCartOps() {
		...
		String cartKey;
		if (userInfoTo.getUserId() != null) {
			//说明用户登录了，Redis存入带UserId louismall:cart:11
			cartKey = CART_PREFIX + userInfoTo.getUserId();
		} else {
			//说明是临时用户，Redis存入带uuid louismall:cart:fg1argadr3gdab3dgfsr41ag
