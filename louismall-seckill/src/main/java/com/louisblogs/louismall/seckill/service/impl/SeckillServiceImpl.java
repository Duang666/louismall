...
import com.louisblogs.louismall.seckill.feign.CouponFeignService;
import com.louisblogs.louismall.seckill.feign.ProductFeignService;
...
import com.louisblogs.louismall.seckill.vo.SeckillSessionsWithSkus;
...
//					long now = new Date().getTime();
	...
	public String kill(String killId, String key, Integer num) {
		...
		MemberRespVo memberResVo = LoginUserInterceptor.loginUser.get();
